...
signal projectile_tracer(projectile_id: int, shooter_id: int, origin: Vector3, velocity: Vector3, weapon_id: String)
signal projectile_impact(projectile_id: int, position: Vector3)
